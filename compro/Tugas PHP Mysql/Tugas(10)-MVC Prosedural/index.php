...
<body>
	...
	<a href="controller.php?action=insert" style="font-size: 20px;">Insert Data Product</a>
	<br><br>
	...
	<table border="1" cellspacing="0" cellpadding="5">
		...
		<tbody>
			...
			<tr>
				...
				<td>
					<a href="view.php?id=<?= $dp['product_id']; ?>">Edit</a> |
					<a href="controller.php?id=<?= $dp['product_id'];?>">Hapus</a>
				</td>	
			</tr>
		<?php 	endforeach; ?>
		</tbody>
